...
<html lang="en">
  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <nav id="header" class="fixed w-full z-30 top-0 text-white">
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
            ...
            @guest
            <ul class="list-reset lg:flex justify-end flex-1 items-center">
                <li class="mr-3" style="background: rgb(218, 73, 73);border-radius: 10px 30px 20px;">
                <a href="{{ route('login') }}" style="color:#fff;" class="inline-block py-2 px-4 text-black font-bold no-underline" href="#">Login</a>
                </li>
                @if (Route::has('register'))
                    <li class="mr-3"  style="background: rgb(218, 73, 73);border-radius: 10px 30px 30px;">
                    <a href="{{ route('register') }}" style="color:#fff;" class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#">Registrase</a>
                    </li>
                @endif
    ...
    <div class="pt-24">
      <a  href="/chatify" style="cursor: pointer;margin-left: 100px;background: #23AECA;padding: 10px;border-radius: 10px;box-shadow: 1px 2px 10px #ccc;">
        Chatea ahora
      </a>
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        <!--Left Col-->
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full">Que estas esperando?</p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
            Chatea ahora con tus contactos!
          </h1>
         
        </div>
        <!--Right Col-->
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-4/5 z-50" src="https://prolipa.com.ec/puntos_de_venta/logo_prolipa.jpg" style="border-radius: 10px 20px 30px;box-shadow: 10px 20px 30px #ccc;" />
        </div>
      </div>
    </div>
